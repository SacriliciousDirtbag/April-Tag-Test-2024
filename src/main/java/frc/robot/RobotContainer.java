...
public class RobotContainer {
    ...
    */
    ...
    public final cameraSubsystem s_cameraSubsystem = new cameraSubsystem();
    ...
    public RobotContainer() {
        ...
        m_Chooser.setDefaultOption("Middle Auto", m_middleCommand);
        m_Chooser.addOption("Left Auto", m_leftCommand);
        m_Chooser.addOption("Right Auto", m_rightCommand);
        m_Chooser.addOption("High Cube Auto", s_HighCubeAuto);
