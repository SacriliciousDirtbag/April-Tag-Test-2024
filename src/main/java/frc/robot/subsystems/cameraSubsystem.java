...
public class cameraSubsystem extends SubsystemBase{
    ...
    public final AtomicReference<Double> czp = new AtomicReference<Double>();
    ...
    new Thread(
        () -> {
          ...
          quadThreshParams.minClusterPixels = 150;
  ...
  public AtomicReference<Double> getCZP() {
    return czp;
  }

  @Override
  public void periodic(){
    //SmartDashboard.put("czp", czp);
  }
}